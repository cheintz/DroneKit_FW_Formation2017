...
defaultParams.ctrlGains = {'kl':KPID(.35,0.005*0, 0), 'ka': KPID(0.1,0*.002,0.01*0),'alpha1': 0.001,'alpha2':100,'d':0.01
	,'vMin': 10,'vMax':30,'kBackstep':0,'aFilterHdg':0.1,'aFilterSpd':.02, 'aFilterThetaDDot': 0.1,'ktheta':KPID(1.0,0.25,1.15)
	,'kSpeed':KPID(6.7,1.6,4),'rollLimit':65/(180/m.pi),'kalt':KPID(0.05,.001,.005),'pitchLimit':25/(180/m.pi)
	,'maxEqil':100, 'maxETheta':10,'maxEAlt':50,'kThetaFF':0, 'aSpeed':0.4,'Ks':2 }
