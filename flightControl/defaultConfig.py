...
defaultParams.ctrlGains = {'kl':0.1, 'ka': 0.0001,'alpha1': 0.001,'alpha2':100,'d':0.01,'vMin': 10,'vMax':28,'kBackstep':0,'aFilter':0.1, 'aFilterThetaDDot': 0.1,'ktheta':1.3, 'headingRateLimit':0.7,'kpAlt':0.2,'kiAlt':0.00,'climbLimit':2.0}
