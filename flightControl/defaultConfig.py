...
defaultParams.ctrlGains = {'kl':0.1, 'ka': 0.0001,'alpha1': 0.001,'alpha2':100,'d':0.01,'vMin': 15,'vMax':24,'kBackstep':0,'aFilter':0.1, 'aFilterThetaDDot': 0.1,'ktheta':0.25, 'headingRateLimit':0.6,'kpAlt':0.2,'kiAlt':0.02}
