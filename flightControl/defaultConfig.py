...
defaultParams.ctrlGains = {'kl':KPID(.4,0*0.005, 0*0.1), 'ka': KPID(0,0,0),'alpha1': 0.001,'alpha2':100,'d':0.01,'vMin': 10,'vMax':30,'kBackstep':0,'aFilterHdg':0.1,'aFilterSpd':.02, 'aFilterThetaDDot': 0.1,'ktheta':KPID(.7,.05,0.1),'kspeed':KPID(6,0*.1,4), 'headingRateLimit':0.7,'kalt':KPID(0.15,.01,.06),'climbLimit':2.0}
...
defaultParams.speedGain = 2000/20
