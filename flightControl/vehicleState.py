...
PIDTerms = recordtype('PIDTerms',['p','i','d','ff','unsaturatedOutput','extraGain'],default = 0.0)
...
Command = recordtype('Command',['sdi','sdt','sdiDot','ui','asTarget',('omega',zeroVect),'psiD','psiDDot','thetaD','rollCMD','thetaDDot',
