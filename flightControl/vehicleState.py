...
VehicleState = recordtype('VehicleState', [ ('isArmable' , False) ,'ID', 'time',  'attitude', 'channels', 'position', 'velocity',('heading',0.0),('headingRate',0.0),('thetaDDotApprox',0.0), 'mode', ('command',Command()), ('isFlocking',False), ('RCLatch', True), 'abortReason', ('timeout', Timeout()), ('parameters',Parameter()),('servoOut',{'1':None,'2':None,'3':None})], default = None )
